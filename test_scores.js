...
function addScore() {
    ...
    //     return;
    // }
    let scoreEntered = parseInt(score.val());
    
    // if (scoreEntered > 100 || scoreEntered < 0 || isNaN(scoreEntered)) {
    //     alert('Score must be in between 0 - 100');
    //     return;
    // }
    
    scoresArr.push(scoreEntered);
